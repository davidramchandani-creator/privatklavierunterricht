...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-600 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[#1C244B] text-white shadow hover:bg-[#151c3d] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
        gold:
          "bg-[#C9A84C] text-white shadow hover:bg-[#b8943a] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] font-700",
        outline:
          "border-2 border-[#1C244B] text-[#1C244B] bg-transparent hover:bg-[#1C244B] hover:text-white hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
        ghost:
