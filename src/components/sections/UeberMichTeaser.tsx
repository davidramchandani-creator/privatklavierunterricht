        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-[4/5] max-w-md mx-auto lg:mx-0 rounded-2xl overflow-hidden bg-gray-100">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#3730A3] to-[#2a3469] flex items-center justify-center">
            ...
            {/* Floating stat */}
            <div className="absolute -bottom-4 -right-4 lg:right-0 bg-[#C9A84C] text-[#3730A3] rounded-2xl px-5 py-4 shadow-lg shadow-[#C9A84C]/30">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl sm:text-4xl font-800 text-[#3730A3] mb-6 leading-tight">
